...
- **Document any change in behaviour** - Clearly note any changes, so [ArrayObjectExtended's documentation](https://github.com/code-distortion/array-object-extended) can be updated.
